...
interface FullTaskGroupMenuProps {
  setGroupMenuIsOpen: (value: boolean) => void;
  taskId: Id<"tasks">;
  groupId: Id<"taskGroups"> | undefined;
  groupMenuIsOpen: boolean;
}

const contextMenu = cva("contextMenu absolute bg-white shadow-lg rounded-md p-1 z-10 border border-gray-200 w-1/2 bottom-13 text-sm")
...
export default function FullTaskGroupMenu({setGroupMenuIsOpen, taskId, groupId, groupMenuIsOpen}: FullTaskGroupMenuProps) {
  ...
  }, [groupMenuIsOpen, setGroupMenuIsOpen]);
